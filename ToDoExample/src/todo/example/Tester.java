...
public class Tester {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 6:	System.out.println("provide todo Id for updation: ");
			        String str=scanner.next();
			        System.out.println("Enter task for updation:");
			        String h=scanner.next();
			        ToDo toDo2 = tester.service.updateToDo(str,h);
			        if (toDo2 != null) {
						System.out.println(toDo2+" is successfully updated");
					} else {
						System.out.println("no such todo is available");
					}
					break;
			case 0:
